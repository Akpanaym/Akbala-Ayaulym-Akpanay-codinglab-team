        ...
        <div class="well well-sm">
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input id="name" name="firstname" type="text" placeholder="Your name" class="form-control">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input id="email" name="lastname" type="text" placeholder="Your email" class="form-control">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                ...
                <input type="submit"  value="Sent" name ="sub" class="btn btn-primary but "/>
...
$obj->saveRecords($firstname,$lastname,$message);  // it is a function to save the data from the form 
}
?>
